...
def applyHandPointsVideo(img_path):
    ...
    try:
        ...
        print("Error in processing hand:", str(e))
...
def applyHandPointsUpload(img_path):
    ...
    try:
        ...
        print("Error in processing upload:", str(e))
        return "Hand not detected"
...
def upload():
    if request.method=='POST':
        ...
        return jsonify({"result": result, "predicted_alphabet": result})
...
if __name__=='__main__':
    app.run(debug=True, host='0.0.0.0', port=5926)